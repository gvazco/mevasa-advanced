"use strict";
exports.id = "component---src-pages-blog-wp-post-uri-js";
exports.ids = ["component---src-pages-blog-wp-post-uri-js"];
exports.modules = {
...
const Wrapper = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].div.withConfig({
  displayName: "wpPosturi__Wrapper"
...
const ContentWrapper = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].div.withConfig({
  displayName: "wpPosturi__ContentWrapper"
})(["display:block;@media (min-width:992px){display:flex;}"]);
const StyledImg = (0,styled_components__WEBPACK_IMPORTED_MODULE_7__["default"])(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_8__.GatsbyImage).withConfig({
  displayName: "wpPosturi__StyledImg"
})(["img{transition:all 0.3s !important;}"]);
const Image = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].div.withConfig({
  displayName: "wpPosturi__Image"
...
const PostContent = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].article.withConfig({
  displayName: "wpPosturi__PostContent"
...
const PostTemplate = ({
  ...
  image: data.post.featuredImage.node.localFile.childImageSharp.gatsbyImageData,
  alt: "Blog Image"
})), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  dangerouslySetInnerHTML: {
    __html: (0,_utils_TransformOembedToIframe__WEBPACK_IMPORTED_MODULE_6__["default"])(data.post.content)
  }
})))));

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PostTemplate);
const PageQuery = "514953579";
...
;
//# sourceMappingURL=component---src-pages-blog-wp-post-uri-js.js.map