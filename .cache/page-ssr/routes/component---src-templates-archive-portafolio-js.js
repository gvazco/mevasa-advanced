"use strict";
exports.id = "component---src-templates-archive-portafolio-js";
exports.ids = ["component---src-templates-archive-portafolio-js"];
exports.modules = {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var gatsby__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gatsby */ "./.cache/gatsby-browser-entry.js");
/* harmony import */ var _Pagination_styles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Pagination.styles */ "./src/components/Pagination/Pagination.styles.js");
...
const Pagination = ({
  ...
  page,
  totalPages
}) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Pagination_styles__WEBPACK_IMPORTED_MODULE_2__.StyledH2, null, "Navegaci\xF3n - P\xE1gina ", page, " / ", totalPages), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Pagination_styles__WEBPACK_IMPORTED_MODULE_2__.Wrapper, {
  isFirst: page === 1
}, page > 1 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  to: `${catUri}${page === 2 ? "" : page - 1}`,
  className: "navBack"
}, "Anterior") : null, page < totalPages ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  to: `${catUri}${page + 1}`,
...
const StyledH2 = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].h2.withConfig({
  displayName: "Paginationstyles__StyledH2"
})(["margin:30px 0;"]);
const Wrapper = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].nav.withConfig({
  displayName: "Paginationstyles__Wrapper"
})(["display:flex;justify-content:space-between;.navBack{font-family:\"Teko\",Arial,Helvetica,sans-serif;font-size:1rem;font-weight:800;color:#fff;position:relative;width:120px;height:30px;display:block;background:#000;padding:3px 10px 0 25px;margin-bottom:30px;:hover{background:#f26e3b;}}.navForward{font-family:\"Teko\",Arial,Helvetica,sans-serif;font-size:1rem;font-weight:800;color:#fff;position:relative;width:120px;height:30px;display:block;background:#000;padding:3px 10px 0 5px;margin-bottom:30px;text-align:center;:hover{background:#f26e3b;}}"]);

/***/ }),

/***/ "./src/components/PortafolioSidebar/PortafolioSidebar.js":
/*!***************************************************************!*\
  !*** ./src/components/PortafolioSidebar/PortafolioSidebar.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var gatsby__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gatsby */ "./.cache/gatsby-browser-entry.js");
/* harmony import */ var _images_tango_page_icon_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../images/tango-page-icon.svg */ "./src/images/tango-page-icon.svg");
/* harmony import */ var _PortafolioSidebar_styles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./PortafolioSidebar.styles */ "./src/components/PortafolioSidebar/PortafolioSidebar.styles.js");





const PortafolioSidebar = ({
  catId,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_PortafolioSidebar_styles__WEBPACK_IMPORTED_MODULE_3__.Wrapper, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_PortafolioSidebar_styles__WEBPACK_IMPORTED_MODULE_3__.Menu, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
    className: "sidebar-menu-header"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
    src: _images_tango_page_icon_svg__WEBPACK_IMPORTED_MODULE_2__["default"],
    alt: "Multycasetas - Proyects Header"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Proyectos")), sortedCategories.map(cat => {
    if (cat.node.count !== 0) {
      return cat.node.slug !== "uncategorized" ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
        key: cat.node.id
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
        className: "count"
      }, cat.node.count), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
        to: cat.node.uri,
        activeClassName: "sidebar-highlighted"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
        dangerouslySetInnerHTML: {
          __html: cat.node.name
        }
      }))) : null;
    }
  })));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PortafolioSidebar);

/***/ }),

/***/ "./src/components/PortafolioSidebar/PortafolioSidebar.styles.js":
/*!**********************************************************************!*\
  !*** ./src/components/PortafolioSidebar/PortafolioSidebar.styles.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Wrapper = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].aside.withConfig({
  displayName: "PortafolioSidebarstyles__Wrapper"
...
const Menu = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].ul.withConfig({
  displayName: "PortafolioSidebarstyles__Menu"
})(["list-style-type:none;padding:0 20px 0 0;margin:0;.count{margin:0 10px 0 0;padding:0;font-size:0.8rem;background:#aaa;color:black;border-radius:20px;width:30px;height:21px;display:block;text-align:center;float:left;font-weight:600;}.sidebar-menu-header{font-family:\"Chub Gotic\",sans-serif;border-bottom:2px #e4e4e4 solid;font-weight:600;letter-spacing:1px;margin:0 0 20px 0;padding:0 0 5px 0;text-transform:uppercase;color:#000;}li{margin:0 0 5px 0px;color:#000;font-family:\"Chub Gotic\",sans-serif;font-size:18px;font-weight:400;letter-spacing:1px;a{color:#000 !important;}a:hover{color:#ff6600 !important;}}.sidebar-highlighted{color:#ff6600;}p{font-size:0.85rem;line-height:1.2rem;letter-spacing:0.5px;a{font-weight:800;color:#000;}}img{float:left;padding:0 10px 0 0;width:38px;height:auto;filter:invert(100%);}"]);
...
/***/ "./src/templates/archivePortafolio.js":
/*!********************************************!*\
  !*** ./src/templates/archivePortafolio.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_PortafolioSidebar_PortafolioSidebar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/PortafolioSidebar/PortafolioSidebar */ "./src/components/PortafolioSidebar/PortafolioSidebar.js");
...
/* harmony import */ var _components_SEO_SEO__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/SEO/SEO */ "./src/components/SEO/SEO.js");
/* harmony import */ var _images_remates_jpg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../images/remates.jpg */ "./src/images/remates.jpg");
/* harmony import */ var _archivePortafolio_styles__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./archivePortafolio.styles */ "./src/templates/archivePortafolio.styles.js");
...
}) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout_Layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_SEO_SEO__WEBPACK_IMPORTED_MODULE_6__["default"], {
  title: "Portafolio de Techos y Mantenimientos | Mevasa",
  description: "Portafolio de proyectos finalizados",
  image: _images_remates_jpg__WEBPACK_IMPORTED_MODULE_7__["default"]
...
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_archivePortafolio_styles__WEBPACK_IMPORTED_MODULE_8__.Wrapper, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_BreadCrumb_BreadCrumb__WEBPACK_IMPORTED_MODULE_3__["default"], {
  parent: {
    uri: "/portafolio/all-proyects",
    title: "portafolio"
  }
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_archivePortafolio_styles__WEBPACK_IMPORTED_MODULE_8__.ContentWrapper, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_PortafolioSidebar_PortafolioSidebar__WEBPACK_IMPORTED_MODULE_4__["default"], {
  catId: catId,
  categoriasPortafolios: categoriasPortafolios.edges
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_archivePortafolio_styles__WEBPACK_IMPORTED_MODULE_8__.PageContent, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", {
  dangerouslySetInnerHTML: {
    __html: catName
  }
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  className: "productos-list"
}, allWpProyecto.edges.map(proyect => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("article", {
  key: proyect.node.id,
  className: "entry-content"
}, proyect.node.featuredImage !== null ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_archivePortafolio_styles__WEBPACK_IMPORTED_MODULE_8__.Image, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  to: proyect.node.uri
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_archivePortafolio_styles__WEBPACK_IMPORTED_MODULE_8__.StyledImg, {
  image: proyect.node.featuredImage.node.localFile.childImageSharp.gatsbyImageData,
  alt: "Galeria Image"
}))) : null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  className: "content"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  to: proyect.node.uri
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_archivePortafolio_styles__WEBPACK_IMPORTED_MODULE_8__.StyledH2, {
  dangerouslySetInnerHTML: {
    __html: proyect.node.title
  }
})), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_archivePortafolio_styles__WEBPACK_IMPORTED_MODULE_8__.StyledDate, {
  dangerouslySetInnerHTML: {
    __html: proyect.node.date
  }
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
  dangerouslySetInnerHTML: {
    __html: proyect.node.excerpt
  }
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_archivePortafolio_styles__WEBPACK_IMPORTED_MODULE_8__.StyledReadMore, {
  to: proyect.node.uri
}, "Leer m\xE1s...")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  className: "dot-divider"
})))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Pagination_Pagination__WEBPACK_IMPORTED_MODULE_5__["default"], {
  catUri: catUri,
  page: currentPage,
  totalPages: numPages
})))));

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (archivePortafolio);
const pageQuery = "1595037717";

/***/ }),

/***/ "./src/templates/archivePortafolio.styles.js":
/*!***************************************************!*\
  !*** ./src/templates/archivePortafolio.styles.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "StyledH2": () => (/* binding */ StyledH2),
/* harmony export */   "StyledDate": () => (/* binding */ StyledDate),
/* harmony export */   "StyledReadMore": () => (/* binding */ StyledReadMore)
/* harmony export */ });
...
const StyledImg = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_2__.GatsbyImage).withConfig({
  displayName: "archivePortafoliostyles__StyledImg"
})(["img{transition:all 0.3s !important;}"]);
const Image = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "archivePortafoliostyles__Image"
})(["margin-bottom:20px;width:100%;max-height:100%;position:relative;overflow:hidden;img{filter:brightness(90%);transition:0.3s ease-in;}:hover img{filter:brightness(100%);transform:scale(1.1);filter:blur(2px);}@media (min-width:768px){width:100%;}"]);
const Wrapper = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "archivePortafoliostyles__Wrapper"
})(["max-width:1180px;margin:0 auto;padding:20px;"]);
const ContentWrapper = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "archivePortafoliostyles__ContentWrapper"
})(["display:block;@media (min-width:992px){display:flex;}"]);
const PageContent = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].article.withConfig({
  displayName: "archivePortafoliostyles__PageContent"
})(["margin:20px 0 20px 0;.productos-list{display:grid;grid-template-columns:1fr;grid-gap:20px;margin:0 auto;margin-top:20px;padding:0 20px;@media screen and (min-width:768px){grid-template-columns:1fr 1fr 1fr;}}.entry-content{width:100%;box-shadow:3px 3px 5px #999 !important;padding:5px;@media screen and (min-width:768px){max-width:220px;}@media screen and (min-width:1280px){max-width:250px;}}.content{padding:20px;p{overflow:hidden;text-overflow:ellipsis;display:-webkit-box;line-height:25px;max-height:100px;-webkit-line-clamp:4;-webkit-box-orient:vertical;font-size:16px;}}}"]);
const StyledH2 = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].h2.withConfig({
  displayName: "archivePortafoliostyles__StyledH2"
})(["font-weight:500;font-size:20px;color:#000;:hover{color:#ff6600;}"]);
const StyledDate = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "archivePortafoliostyles__StyledDate"
})(["font-family:\"Chub Gotic\",sans-serif;font-size:1rem;font-weight:600;"]);
const StyledReadMore = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(gatsby__WEBPACK_IMPORTED_MODULE_0__.Link).withConfig({
  displayName: "archivePortafoliostyles__StyledReadMore"
})(["font-family:\"Chub Gotic\",sans-serif;font-size:0.85rem;font-weight:800;color:#000;position:relative;width:120px;height:35px;display:block;background:#fff;padding:3px 0 0 10px;:hover{background:#ff6600;color:#fff;}"]);
...
;
//# sourceMappingURL=component---src-templates-archive-portafolio-js.js.map