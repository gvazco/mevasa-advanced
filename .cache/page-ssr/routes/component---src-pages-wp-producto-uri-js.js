"use strict";
exports.id = "component---src-pages-wp-producto-uri-js";
exports.ids = ["component---src-pages-wp-producto-uri-js"];
exports.modules = {
...
const Wrapper = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  displayName: "wpProductouri__Wrapper"
})(["max-width:1180px;margin:0 auto;padding:20px;"]);
const StyledImg = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_7__.GatsbyImage).withConfig({
  displayName: "wpProductouri__StyledImg"
})(["img{transition:all 0.3s !important;}"]);
const Image = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  displayName: "wpProductouri__Image"
})(["margin-bottom:20px;width:100%;max-height:100%;padding:20px;position:relative;overflow:hidden;img{transition:0.3s ease-in;}:hover img{transform:scale(1.1);}@media (min-width:768px){width:100%;}"]);
const ContentWrapper = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  displayName: "wpProductouri__ContentWrapper"
})(["display:block;@media (min-width:992px){display:flex;}"]);
const PostContent = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].article.withConfig({
  displayName: "wpProductouri__PostContent"
...
const ProyectTemplate = ({
  ...
  image: data.item.featuredImage.node.localFile.childImageSharp.gatsbyImageData
...
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Image, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledImg, {
  image: data.item.featuredImage.node.localFile.childImageSharp.gatsbyImageData,
  alt: "Blog Image"
})), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  dangerouslySetInnerHTML: {
    __html: (0,_utils_TransformOembedToIframe__WEBPACK_IMPORTED_MODULE_5__["default"])(data.item.content)
  }
})))));

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProyectTemplate);
const PageQuery = "2206980358";
...
;
//# sourceMappingURL=component---src-pages-wp-producto-uri-js.js.map